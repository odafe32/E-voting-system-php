    ...
    <div class="container">
        <div class="hero-section">
            ...
            <div class="hero-content">
                ...
                <h1 class="hero-title">SECURE DIGITAL DEMOCRACY</h1>
                <p class="hero-subtitle">Experience transparent, efficient, and trustworthy voting</p>
                ...
                <div class="features">
                    ...
                    <div class="feature">
                        ...
                        <span>Real-time results & transparency</span>
                    </div>
                    <div class="feature">
                ...
                <div class="testimonial">
                    <div class="testimonial-text">
                        "Finally, no long queues or ballot tampering. This platform is secure, transparent, and gave us real-time results."
                    </div>
                    <div class="testimonial-author">
                        — Chinedu Okafor, 400L Computer Science
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="login-box-body">
                    ...
                    <form action="login.php" method="POST">
                        <div class="form-group has-feedback">
                            ...
                            <span class="glyphicon glyphicon-user form-control-feedback"><i class="fas fa-user"></i></span>
                        </div>
                        <div class="form-group has-feedback">
                            <input type="password" class="form-control" name="password" placeholder="Password" required>
                            <span class="glyphicon glyphicon-lock form-control-feedback"><i class="fas fa-lock"></i></span>
                        </div>
                        <div class="row">
                            <div class="col-xs-4">
            ...
            inputs.forEach(input => {
                ...
                input.addEventListener('input', function() {
                    if (this.value.length > 0) {
                        ...
                        this.nextElementSibling.style.color = '#16a34a';
                    } else {
